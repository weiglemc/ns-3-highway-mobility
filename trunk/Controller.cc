...
namespace ns3 {
    ...
    bool Controller::InitVehicle(Ptr<Highway> highway, int& VID) {
        ...
        obstacle->SetDirection(highway->GetDirection());
        obstacle->SetLane(highway->GetNumberOfLanes());

        obstacle->SetPosition(highway->GetPosition(true, 500, highway->GetNumberOfLanes()));
        ...
        police->SetDirection(highway->GetDirection());
        police->SetLane(highway->GetNumberOfLanes() - 1);
        police->SetPosition(highway->GetLaneStart(highway->GetNumberOfLanes() - 1));
        //police->SetPosition(Vector(0.0, highway->GetYForLane(1,1), 0));
        police->SetVelocity(36.0);
